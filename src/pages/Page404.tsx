...
export default function Page404() {
  ...
  useEffect(() => {
    document.title = t('page404.textTitlePage')
      ...
      <div className="container ">
        <div className="left-section ">
          <div className="inner-content">
            <h1 className="heading">{t('page404.h1')}</h1>
            <p className="subheading">{t('page404.text')}</p>

            <AppButton
              href={'/'}
              btnClasses=" relative border-0 rounded-2xl border-[var(--hover-bg-color)] py-4 px-8  text-2xl  transition ease-in-out  duration-150 hover:scale-[105%] active:scale-[95%] shadow-[0_2px_5px_2px_rgba(30,27,75,0.1)] hover:shadow-[0_5px_10px_5px_rgba(30,27,75,0.2)] dark:shadow-[0_2px_5px_2px_rgba(255,255,255,0.2)] dark:hover:shadow-[0_5px_10px_5px_rgba(255,255,255,0.2)] mt-12"
            >
              <>
                {t('page404.btnText')}
